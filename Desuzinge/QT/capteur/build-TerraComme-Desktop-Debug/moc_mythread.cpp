...
QT_MOC_LITERAL(3, 19, 7)
    ...
    "MyThread\0acquerir\0\0Mesures\0"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->acquerir(); break;
        case 1: _t->acquerir((*reinterpret_cast< Mesures(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::acquerir)) {
                *result = 0;
            }
        }
        {
            typedef void (MyThread::*_t)(Mesures );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::acquerir)) {
                *result = 1;
            }
        }
...
// SIGNAL 0
void MyThread::acquerir()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void MyThread::acquerir(Mesures _t1)
{
